...
content = content.replace(/const startListening = useCallback\(\(\) => \{[\s\S]*?\}, \[uiLanguage, lang, continuous, interimResults, getLocalizedMessages, onTranscript, onStart, onEnd, onError\]\);/, `const startListening = useCallback(() => {
