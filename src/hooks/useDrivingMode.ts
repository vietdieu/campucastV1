...
import { getFuzzySimilarity } from "../services/VoiceCommandEngine";
...
export function matchAndStripWakeWord(text: string, uiLanguage: "vi" | "en"): { matched: boolean; stripped: string } {
  ...
  const wakeWords = uiLanguage === "vi" 
    ? ["cast ơi", "này cast", "ơi cast", "cát ơi", "này cát", "này kết", "kết ơi", "cáp ơi"]
  ...
  // 2. Fuzzy / Phonetic Levenshtein matching
