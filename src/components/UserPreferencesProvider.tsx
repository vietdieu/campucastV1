  ...
  const [preferences, setPreferences] = useState<BroadcastConfiguration>(() => {
    try {
      ...
      if (saved) {
        ...
        const isDrivingMode = false; // Always default to false on initial load
        ...
        const hapticFeedbackEnabled = parsed.hapticFeedbackEnabled !== undefined ? parsed.hapticFeedbackEnabled : DEFAULT_PREFERENCES.hapticFeedbackEnabled;
        const wakeWordEnabled = parsed.wakeWordEnabled !== undefined ? parsed.wakeWordEnabled : DEFAULT_PREFERENCES.wakeWordEnabled;
        const autoSuggestDrivingModeEnabled = parsed.autoSuggestDrivingModeEnabled !== undefined ? parsed.autoSuggestDrivingModeEnabled : DEFAULT_PREFERENCES.autoSuggestDrivingModeEnabled;
